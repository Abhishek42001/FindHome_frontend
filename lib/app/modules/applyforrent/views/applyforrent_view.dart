                        ...
                        child: SingleChildScrollView(
                          child: Column(
                            ...
                            children: [
                              ...
                              SizedBox(height:13),
                              CustomFormField(
                                  validator: (s) => applyController.checkOwnerName(s),
                                  maxlength:25,
                              ...
                              CustomPrimaryButton(
                                  ...
                                  onTap: () {
                                    ...
                                    if(applyController.dropdownvalue.value.isEmpty){
                                      showDialog(
                                    ...
                                    if(applyController.imagefile.value.isEmpty){
                                      showDialog(
                                        context: context, builder:(context)=>AlertDialog(
                                          title: Text("Oops"),
                                          content: Text("Please Upload Main Photo."),
                                          actions: [
                                             TextButton(
                                                child: Text("OK"),
                                                onPressed: () {Get.back(); },
                                    ...
                                    if(applyController.images.isEmpty){
                                      showDialog(
                                        context: context, builder:(context)=>AlertDialog(
                                          title: Text("Oops"),
                                          content: Text("Please Upload At least one photo in upload photos section."),
                                          actions: [
                                             TextButton(
                                                child: Text("OK"),
                                                onPressed: () {Get.back(); },
