                    ...
                    GestureDetector(
                      onTap: () {
                        Get.toNamed("/photogallery", arguments: [
                          {"images": galleryController.data['main_image']}
                        ]);
                      },
                      child: Container(
                    ...
                    Padding(
                      ...
                      child: GridView.count(
                        ...
                        children: List.generate(
                          galleryController.data['images'].length,
                          (index) => GestureDetector(
                            onTap: () async {
                              print(galleryController.data['images']);
                              Get.toNamed("/photogallery",
                                  arguments: galleryController.data['images']);
                            },
                            child: Container(
                              height: 135,
                              width: 135,
                              decoration: BoxDecoration(
                                ...
                                image: DecorationImage(
                                  image: CachedNetworkImageProvider(
                                    "https://res.cloudinary.com/dmmodq1b9/" +
                                        galleryController.data['images'][index]
                                            ['images'],
                                  ),
                                  fit: BoxFit.cover,
                                ),
